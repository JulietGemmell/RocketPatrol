class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.anims.create({
            key: 'flight',
            frames: this.anims.generateFrameNumbers('shipanimation', { start: 0, end: 2, first: 0}),
            frameRate: 2
        });
    ...
    shipFlight(ship) {
        let wing = this.add.sprite(ship.x, ship.y, 'flight').setOrigin(0, 0);
        wing.anims.play('flight');
    }
}